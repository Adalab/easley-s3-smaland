...
class CollapsableContainer extends Component {
  ...
  saveSkills(event) {
    ...
    return dataBack.skills.push(valueInput);
  }
        ...
        <section className="design-card">
          <div className="title-dropdown">
            ...
            <div className="title-dropdown__arrow arrowDesign">
              <i className="arrowD fas fa-chevron-up" />
            </div>
          </div>
              ...
              <form className="design-Card__colors__select-font">
                <label htmlFor="font-Ubuntu" className="font">
                  <input
                    ...
                    required
                    name="selectFont"
                    onChange={this.props.handleFontInput}
                  />
        ...
        <section className="fill-card">
          ...
          <form action="/signup" method="post" className="form ">
            ...
            <div className="container-image">
              <button className="image-link" type="submit">
                Añadir imagen
              </button>
              <input
                type="file"
          ...
          <div className="container-section">
            ...
            <div className="container-share hidden">
              ...
              <div className="container-hide-section hidden">
                ...
                <a className="link-profile-card" href="enlace a tarjeta" />
