...
class FillContainer extends Component {
  render() {
    ...
    const icon = <i className="far fa-keyboard" />;
    const text = <p className="title-dropdown__title-fill">Rellena</p>;
    const divTitle = (
    ...
    const arrow = <i className="arrowF fas fa-chevron-down" />;
    const divArrow = (
      <div className="title-dropdown__arrow arrowFill">{arrow}</div>
    );
    const title = (
        ...
        <section className="fill-card">
          <form action="/signup" method="post" className="form">
            ...
            <Input
              name="email"
              content="Email"
              example="Ej: sally-hill@gmail.com"
              type="email"
